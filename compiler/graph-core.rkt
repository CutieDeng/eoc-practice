...
(define (graph-make-empty) (Graph integer-compare (ordl-make-empty integer-compare) (ordl-make-empty integer-compare)))
...
(define (graph-make-empty-normal) 
    (define graph (Graph integer-compare (ordl-make-empty integer-compare) (ordl-make-empty integer-compare)))
    (add-vertex (add-vertex graph 0) 1)
)
(provide graph-make-empty-normal)
